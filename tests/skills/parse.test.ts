...
import { parseSkill, parseSimpleYaml, skillMatchesUrl } from '../../src/skills/parse';
...
把文章改写为小红书风格。`;
    ...
    expect(frontmatter.panelot?.variables?.[0]).toMatchObject({ key: 'tone', type: 'select', options: ['活泼', '专业'] });
