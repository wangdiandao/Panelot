...
Panelot is a WXT, React, and TypeScript Chrome MV3 extension. Start with the [documentation index](./docs/README.md), then read the contract for the behavior you plan to change.
