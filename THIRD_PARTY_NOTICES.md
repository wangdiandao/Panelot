...
Panelot is distributed under the MIT License and includes open-source dependencies under their respective licenses. The authoritative dependency set is `pnpm-lock.yaml`; release SBOM artifacts provide the exact package and version inventory.
